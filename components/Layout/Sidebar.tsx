  ...
  return (
    <aside
      ...
      className={`fixed top-0 left-0 h-full bg-white shadow-md z-30 transition-all duration-300 ease-in-out ${
        sidebarOpen || hoveredSidebar ? "w-64" : "w-20"
      }`}
    >
      {/* Logo Section */}
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          {(sidebarOpen || hoveredSidebar) && (
            <div className="text-center space-y-0.5 transition-opacity duration-300">
              <h4 className="font-semibold text-gray-800 text-md whitespace-nowrap">
                {user?.name}
              </h4>
      ...
      <nav
        ...
        style={{ maxHeight: "calc(100vh - 160px)",paddingBottom:"100px" }} // 160px adjust for logo+profile
      >
        <ul className="space-y-1">
          ...
          <li>
            ...
            >
              ...
              {(sidebarOpen || hoveredSidebar) && (
                <span className="ml-3 whitespace-nowrap">Fund Request</span>
              )}
            </Link>
          </li>
          ...
          <li>
            ...
            >
              ...
              {(sidebarOpen || hoveredSidebar) && (
                <span className="ml-3 whitespace-nowrap">Ledger Report</span>
              )}
            </Link>
          </li>
          ...
          <li>
            ...
            >
              ...
              {(sidebarOpen || hoveredSidebar) && (
                <span className="ml-3 whitespace-nowrap">Wallet Report</span>
              )}
            </Link>
          </li>
          ...
          <li>
            ...
            >
              ...
              {(sidebarOpen || hoveredSidebar) && (
                <span className="ml-3 whitespace-nowrap">Developer</span>
              )}
            </Link>
          </li>
          ...
          <li>
            ...
            >
              ...
              {(sidebarOpen || hoveredSidebar) && (
                <span className="ml-3 whitespace-nowrap">My Profile</span>
              )}
            </Link>
          </li>
          ...
          <li className="relative">
            <button
              ...
              onClick={() => setCscOpen((prev) => !prev)}
            >
              <FaUser className="text-lg min-w-[24px]" />
              {(sidebarOpen || hoveredSidebar) && (
                <span className="ml-3 whitespace-nowrap">CSC</span>
              )}
            </button>
