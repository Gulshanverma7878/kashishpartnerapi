...
function PaycardTable() {
    ...
    const filteredData = data.filter((item)=>item.csc_id.toLowerCase().includes(searchTerm.toLowerCase()) || item.card.toLowerCase().includes(searchTerm.toLowerCase()) || item.status.toLowerCase().includes(searchTerm.toLowerCase()));
    // Sort data
    const sortedData = [
        ...filteredData
    ].sort((a, b)=>{
...
//# sourceMappingURL=_585303b1._.js.map