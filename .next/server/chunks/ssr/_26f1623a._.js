...
__turbopack_context__.s({
    "editTopupRecord": (()=>editTopupRecord),
...
const editTopupRecord = async (id, updatedData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].put(`cscsession/history/${id}`, updatedData);
...
//# sourceMappingURL=_26f1623a._.js.map